...
const Signup = ({isAlreadyMember}) => {
    ...
    const handeSignup = (user) => {
        axios.post(`${API_URL}post/user/register`,user)
            .then(res => {
                console.log(res);
            })
    }
                ...
                <div className='mb-5'>
                    <div className="authInputWrapper">
                        ...
                        <input 
                            ...
                            {...userSignup.getFieldProps('fullName')}/>
                    </div>   
                        {
                            userSignup.touched.fullName && userSignup.errors.fullName &&
            
                            <p className='text-red-400'>{userSignup.errors.fullName}</p>
